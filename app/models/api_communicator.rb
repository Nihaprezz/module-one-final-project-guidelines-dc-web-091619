...
def all_teams_hashes #only gets teams for 4 leagues
    ...
    spain_string=RestClient.get("https://api.football-data.org/v2/competitions/2014/teams", {"X-Auth-Token"=> "ebf9f744f51940048af126de1c5c27b7"})
    spain_arr=JSON.parse(spain_string)["teams"]
    italy_string=RestClient.get("https://api.football-data.org/v2/competitions/2019/teams", {"X-Auth-Token"=> "ebf9f744f51940048af126de1c5c27b7"})
